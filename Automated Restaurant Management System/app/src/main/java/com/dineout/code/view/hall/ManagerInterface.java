package com.dineout.code.view.hall;
...
import com.dineout.code.controller.hall.Tracking;
import com.dineout.code.view.admin.LoginActivity;
...
import com.dineout.code.model.hall.DB.Employee;
import com.dineout.code.model.hall.DB.Item;
import com.dineout.code.model.hall.DB.MenuItem;
import com.dineout.code.model.hall.DB.Menu;
import com.dineout.code.controller.hall.ReadytoServeOrders;
...
public class ManagerInterface extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View V) {
                Intent myIntent = new Intent(ManagerInterface.this,com.dineout.code.view.billing.PendingPayments.class);
                startActivity(myIntent);
            }
        });
